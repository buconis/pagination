...
public class PaginationController {
    ...
    public Page<Book> getAllPaginatedBooks(Pageable pageable) {
        return bookService.getAllPaginatedBooks(pageable);
    }

    @RequestMapping(value = "/books-search", method = RequestMethod.GET)
    public Page<Book> getSearchedPaginatedBooks(@RequestParam("type") String queryType,
        ...
        return bookService.searchBooksWithPagination(page, length, searchTerm, genres, periods, authors, sort, sortDirection, queryType);
    }
